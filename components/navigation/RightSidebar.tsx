...
const RightSidebar = () => {
  const hotQuestions = [
    ...
    { _id: "3", title: "How to create a responsive layout with Flexbox?" },
    { _id: "4", title: "What are the new features in ES6?" },
    { _id: "5", title: "How to optimize React performance?" },
  ];

  const popularTags = [
    { _id: "1", name: "JavaScript", questions: 1200 },
    { _id: "2", name: "CSS3", questions: 900 },
    { _id: "3", name: "React", questions: 1500 },
    { _id: "4", name: "Node.js", questions: 800 },
    { _id: "5", name: "Python", questions: 2000 },
  ];
  return (
