...
const TagCard = ({
  ...
  if (compact) {
    // If compact is true, render a smaller version of the tag card without the link and with an optional remove button, otherwise render the full version with the link.
    return isButton ? (
      <button
